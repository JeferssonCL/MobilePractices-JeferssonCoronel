...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    private fun beginRouteTracking() {
        if (!checkLocationPermission()) {
            askForLocationPermission()
            return
        }
    ...
    private fun finishRouteTracking() {
        isTracking = false
    ...
    private fun promptRouteSaveDialog() {
        ...
        AlertDialog.Builder(this)
            ...
            .setPositiveButton("Save") { _, _ ->
                ...
                persistRouteToDatabase()
            }
            .setNegativeButton("Cancel", null)
            .show()
    }

    private fun persistRouteToDatabase() {
    ...
    private fun fetchAndDisplayRoute(routeId: Long) {
    ...
    private fun renderRoutePathOnMap(route: Route) {
        if (!::map.isInitialized) {
        ...
        if (route.locations.isEmpty()) {
            ...
            Toast.makeText(this, "This route has no points to display", Toast.LENGTH_SHORT).show()
            return
        }
    ...
    private fun activateMyLocationFeature() {
